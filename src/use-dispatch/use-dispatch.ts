...
export class UseDispatch extends StimulusUse {
  ...
  dispatch = (eventName: string, detail = {}): CustomEvent => {
    ...
    warn(
      '`useDispatch()` is deprecated. Please use the built-in `this.dispatch()` function from Stimulus. You can find more information on how to upgrade at: https://stimulus-use.dev/use-dispatch'
    )
