...
### Observers
  ...
  |[`useLazyLoad`](./docs/use-lazy-load.md) | Lazily loads an image once it scrolls into the viewport and adds **loading**, **loaded** callbacks to your controller.|`loading`<br> `loaded`|
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center" valign="top" width="14.28%"><a href="https://kerricklong.com/"><img src="https://avatars.githubusercontent.com/u/552093?v=4?s=80" width="80px;" alt="Kerrick Long"/><br /><sub><b>Kerrick Long</b></sub></a><br /><a href="https://github.com/stimulus-use/stimulus-use/commits?author=Kerrick" title="Code">💻</a> <a href="https://github.com/stimulus-use/stimulus-use/commits?author=Kerrick" title="Documentation">📖</a></td>
